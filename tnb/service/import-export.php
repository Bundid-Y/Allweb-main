...
<head>
  ...
  <title>บริการขนส่งคอนเทนเนอร์นำเข้า-ส่งออก | TNB Logistics</title>
  <meta name="description" content="บริการขนส่งคอนเทนเนอร์นำเข้า-ส่งออกของ TNB Logistics ครอบคลุมทุกท่าเรือและโรงงาน" />

     <!-- Google SEO -->
     <meta name="robots" content="index, follow" />
     <link rel="canonical" href="https://tnb-logistics.com/service/import-export.html" />

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://tnb-logistics.com/service/import-export.html" />
    <meta property="og:title" content="บริการขนส่งคอนเทนเนอร์นำเข้า-ส่งออก | TNB Logistics" />
    <meta property="og:description" content="บริการขนส่งคอนเทนเนอร์นำเข้า-ส่งออกของ TNB Logistics ครอบคลุมทุกท่าเรือและโรงงาน" />
...
<body>
    ...
    <div class="svc-row">
      <div class="svc-img-col">
        <div class="svc-image-wrapper">
          <div class="svc-shape svc-shape--left"></div>
      ...
      <div class="svc-text-col">
        <h1 data-i18n="service.import_export_title">บริการขนส่งตู้คอนเทนเนอร์นำเข้า–ส่งออก</h1>
        <h2 data-i18n="service.import_export_subtitle">บริการขนส่งตู้สินค้าที่มั่นใจได้ในทุกขั้นตอน</h2>
        <div class="svc-divider"></div>
        <p class="details-desc" data-i18n="service.import_export_desc">
  ...
  <div class="back-to-services" style="text-align: center; padding: 40px 40px; margin-top: -350px;">
    <a href="../main/index.php#services" class="back-to-services-btn" onclick="window.location.href='../main/index.php#services'; return false;">
