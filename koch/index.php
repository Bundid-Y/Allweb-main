...
<head>
    ...
    <link rel="canonical" href="https://koch-packaging-services.com/index.php" />
    ...
    <meta property="og:description"
        content="Smart, Fast, and Sustainable Solutions สำหรับอุตสาหกรรมยานยนต์ในประเทศไทย - บริการบรรจุภัณฑ์และคลังสินค้าครบวงจร" />
    <meta property="og:url" content="https://koch-packaging-services.com/index.php" />
...
<body>
    ...
    <div class="content-section layout_padding koch-about-section">
        ...
        <div class="koch-about-row">
            ...
            <!-- คอลัมน์ซ้าย: รูปภาพ -->
            <div class="koch-about-col-img anim-fade-right">
            ...
            <!-- คอลัมน์ขวา: เนื้อหา -->
            <div class="koch-about-col-text anim-fade-left">
                ...
                <p class="koch-about-desc">
                    <span data-i18n="index.about_p1">KOCH คือผู้เชี่ยวชาญด้านบริการ Supply Chain ครบวงจร
                        สำหรับอุตสาหกรรมยานยนต์ในประเทศไทย มุ่งเน้นการสร้างระบบที่</span><strong
                        class="koch-about-highlight" data-i18n="index.about_p1_strong">"Smart, Fast, and
                        Sustainable"</strong>
                </p>
                ...
                <p class="koch-about-desc">
                    ...
                    <strong class="koch-about-highlight"
                ...
                <div class="details-action-group">
                    <a href="./about/company.php" class="koch-about-cta"
                        data-i18n="index.about_cta">ดูรายละเอียดเพิ่มเติม</a>
                </div>
            </div>
    ...
    <div class="content-section layout_padding">
        ...
        <div style="margin-bottom: 8px;">
            <div style="text-align: left;" class="anim-fade-up">
        ...
        <div>
            <div class="details-box details-box-services">
                <div class="card-grid">
                    <a class="card anim-fade-up anim-delay-100" href="./service/development.php">
                        ...
                        <div class="card__content">
                            <div class="card__text-box">
                                ...
                                <h3 class="card__heading" data-i18n="index.svc1_heading">
                                    นวัตกรรมการออกแบบบรรจุภัณฑ์ครบวงจร</h3>
                            </div>
                            <span class="card__button" data-i18n="index.svc_btn_readmore">อ่านเพิ่มเติม</span>
                        </div>
                    </a>
                    <a class="card anim-fade-up anim-delay-200" href="./service/supply_management.php">
                        <div class="card__background"
                        ...
                        <div class="card__content">
                            <div class="card__text-box">
                                ...
                                <h3 class="card__heading" data-i18n="index.svc2_heading">
                                    ระบบบริหารจัดการบรรจุภัณฑ์อัจฉริยะ</h3>
                            </div>
                            <span class="card__button" data-i18n="index.svc_btn_readmore">อ่านเพิ่มเติม</span>
                        </div>
                    </a>
                    <a class="card anim-fade-up anim-delay-300" href="./service/warehouse.php">
                        <div class="card__background"
                    ...
                    <a class="card anim-fade-up anim-delay-400" href="./service/transportation.php">
                        <div class="card__background"
    ...
    <div class="content-section section-partners" style="padding-top: 80px; padding-bottom: 80px;">
        ...
        <div style="margin-bottom: 24px;">
            <div style="text-align: right;" class="anim-fade-up">
                <h1 class="details-title"
                    style="margin-top: 0; border: none; text-decoration: none; color: #ffffff; text-align: right;"
                    data-i18n="index.partners_title">
                    พันธมิตรที่ไว้วางใจเรา
                </h1>
                <p class="details-desc"
                    style="margin-top: 5px; margin-bottom: 20px; line-height: 1.8; color: #ffffff; text-align: right;"
        ...
        <?php include_once './component/api_customers.php'; ?>
        <section class="loop-images-quotation anim-fade-up anim-delay-200"
            style="--bg: white; height: auto; min-height: 220px; padding: 20px 0;">
            <div class="login-track" style="--time: 60s; --duplicate-factor: 10;">
                <?php
                $i = 1;
                // สร้าง 10 รอบเพื่อให้คลังรูปยาวพอที่จะล้นหน้าจอ (ป้องกันเกิดช่องโหว่สีขาวเมื่อรูปน้อย)
                $batches = array_fill(0, 10, $api_customers);
                foreach ($batches as $batch) {
                    foreach ($batch as $c) {
                        $logo = isset($c['logo']) ? htmlspecialchars($c['logo']) : '';
                        if ($logo) {
                            echo '<div class="login-item" style="--i: ' . $i++ . ';">';
                            echo '<img src="https://koch-packaging-services.com/customer_logo/' . $logo . '" alt="' . htmlspecialchars($c['customer_code']) . '">';
                            echo '</div>';
                        }
                    }
                }
    ...
    <div class="content-section layout_padding section-products">
        ...
        <div class="dev-carousel-root anim-fade-up anim-delay-200">
            <div class="dev-carousel-viewport">
                <div class="dev-carousel-track">
                    ...
                    <div class="dev-carousel-page">
                        <div class="dev-cards">
                            <div class="dev-card"><a href="./main/product.php" rel="noopener noreferrer"><img
                                        src="./img/products/box/rsc.png" alt="RSC Box" loading="lazy">
                                    <div class="dev-card-title">RSC Box</div>
                                    <p class="dev-card-desc">RSC Box</p>
                                </a></div>
                            <div class="dev-card"><a href="./main/product.php" rel="noopener noreferrer"><img
                                        src="./img/products/box/ftd.png" alt="FTD Box" loading="lazy">
                                    <div class="dev-card-title">FTD Box</div>
                                    <p class="dev-card-desc">FTD Box</p>
                                </a></div>
                            <div class="dev-card"><a href="./main/product.php" rel="noopener noreferrer"><img
                                        src="./img/products/box/osc.png" alt="OSC Box" loading="lazy">
                                    <div class="dev-card-title">OSC Box</div>
                                    <p class="dev-card-desc">OSC Box</p>
                                </a></div>
                            <div class="dev-card"><a href="./main/product.php" rel="noopener noreferrer"><img
                                        src="./img/products/box/die-cut.png" alt="Die-Cut Box" loading="lazy">
                                    <div class="dev-card-title">Die-Cut Box</div>
                                    <p class="dev-card-desc">Die-Cut Box</p>
                                </a></div>
                            <div class="dev-card"><a href="./main/product.php" rel="noopener noreferrer"><img
                                        src="./img/products/box/pallet.png" alt="Cardboard Pallet" loading="lazy">
                                    <div class="dev-card-title">Cardboard Pallet</div>
                                    <p class="dev-card-desc">Cardboard Pallet</p>
                                </a></div>
                            <div class="dev-card"><a href="./main/product.php" rel="noopener noreferrer"><img
                                        src="./img/products/box/fit_ser.png" alt="Fitting Box Service" loading="lazy">
                    ...
                    <div class="dev-carousel-page">
                        <div class="dev-cards">
                            <div class="dev-card"><a href="./main/product.php" rel="noopener noreferrer"><img
                                        src="./img/products/Wooden/wooden_crates.png" alt="Wooden Crates"
                                        loading="lazy">
                                    <div class="dev-card-title">Wooden Crates</div>
                                    <p class="dev-card-desc">Wooden Crates</p>
                                </a></div>
                            <div class="dev-card"><a href="./main/product.php" rel="noopener noreferrer"><img
                                        src="./img/products/Wooden/wooden_pallet.png" alt="Wooden Pallet"
                                        loading="lazy">
                                    <div class="dev-card-title">Wooden Pallet</div>
                                    <p class="dev-card-desc">Wooden Pallet</p>
                                </a></div>
                            <div class="dev-card"><a href="./main/product.php" rel="noopener noreferrer"><img
                                        src="./img/products/Wooden/wooden_case.png" alt="Wooden Case" loading="lazy">
                                    <div class="dev-card-title">Wooden Case</div>
                                    <p class="dev-card-desc">Wooden Case</p>
                                </a></div>
                            <div class="dev-card"><a href="./main/product.php" rel="noopener noreferrer"><img
                                        src="./img/products/Plastic/plastic_container.png" alt="Plastic Container"
                                        loading="lazy">
                                    <div class="dev-card-title">Plastic Container</div>
                                    <p class="dev-card-desc">Plastic Container</p>
                                </a></div>
                            <div class="dev-card"><a href="./main/product.php" rel="noopener noreferrer"><img
                                        src="./img/products/Plastic/pp_box.png" alt="PP Box" loading="lazy">
                                    <div class="dev-card-title">PP Box</div>
                                    <p class="dev-card-desc">PP Box</p>
                                </a></div>
                            <div class="dev-card"><a href="./main/product.php" rel="noopener noreferrer"><img
                                        src="./img/products/Plastic/plastic_pallet.png" alt="Plastic Pallet"
                                        loading="lazy">
                                    <div class="dev-card-title">Plastic Pallet</div>
                                    <p class="dev-card-desc">Plastic Pallet</p>
                                </a></div>
                        </div>
                    </div>
                    ...
                    <div class="dev-carousel-page">
                        <div class="dev-cards">
                            <div class="dev-card"><a href="./main/product.php" rel="noopener noreferrer"><img
                                        src="./img/products/Plastic/pp_box_esd.png" alt="PP Box ESD" loading="lazy">
                                    <div class="dev-card-title">PP Box ESD</div>
                                    <p class="dev-card-desc">PP Box ESD</p>
                                </a></div>
                            <div class="dev-card"><a href="./main/product.php" rel="noopener noreferrer"><img
                                        src="./img/products/Plastic/pp_box_partition.png" alt="PP Box Partition"
                                        loading="lazy">
                                    <div class="dev-card-title">PP Box Partition</div>
                                    <p class="dev-card-desc">PP Box Partition</p>
                                </a></div>
                            <div class="dev-card"><a href="./main/product.php" rel="noopener noreferrer"><img
                                        src="./img/products/Plastic/pp_box_partition2.png" alt="PP Box Partition 2"
                                        loading="lazy">
                                    <div class="dev-card-title">PP Box Partition 2</div>
                                    <p class="dev-card-desc">PP Box Partition 2</p>
                                </a></div>
                            <div class="dev-card"><a href="./main/product.php" rel="noopener noreferrer"><img
                                        src="./img/products/Steel/steel_rack.png" alt="Steel Rack" loading="lazy">
                                    <div class="dev-card-title">Steel Rack</div>
                                    <p class="dev-card-desc">Steel Rack</p>
                                </a></div>
                            <div class="dev-card"><a href="./main/product.php" rel="noopener noreferrer"><img
                                        src="./img/products/Steel/steel_rack2.png" alt="Steel Rack 2" loading="lazy">
                                    <div class="dev-card-title">Steel Rack 2</div>
                                    <p class="dev-card-desc">Steel Rack 2</p>
                                </a></div>
                            <div class="dev-card"><a href="./main/product.php" rel="noopener noreferrer"><img
                                        src="./img/products/Steel/steel_rack3.png" alt="Steel Rack 3" loading="lazy">
                                    <div class="dev-card-title">Steel Rack 3</div>
                                    <p class="dev-card-desc">Steel Rack 3</p>
                                </a></div>
                        </div>
                    </div>
